using ExpenseReport.Api.Services;
using ExpenseReport.Application.DTOs.Settings;
using ExpenseReport.Application.Interfaces;
...
using ExpenseReport.Infrastructure.Identity.Services;
using ExpenseReport.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\ExpenseReport.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
