using ExpenseReport.Application.DTOs.Identity;
using ExpenseReport.Application.DTOs.Mail;
using ExpenseReport.Application.DTOs.Settings;
using ExpenseReport.Application.Enums;
using ExpenseReport.Application.Exceptions;
...
namespace ExpenseReport.Infrastructure.Identity.Services
{
