using ExpenseReport.Application.Constants;
...
using ExpenseReport.Application.Features.Products.Commands.Delete;
...
using ExpenseReport.Web.Extensions;
...
namespace ExpenseReport.Web.Areas.Catalog.Controllers
{
    [Area("Catalog")]
